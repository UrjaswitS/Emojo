...
public class MainActivity extends AppCompatActivity {
     ...
     */
    public @OnClick(R.id.emojify_button)
    void emojifyMe(View view) {
     ...
     */
    public @OnClick(R.id.save_button)
    void saveMe(View view) {
     ...
     */
    public @OnClick(R.id.share_button)
    void shareMe(View view) {
        // Delete the temporary image file
        BitmapUtils.deleteImageFile(this, mTempPhotoPath);
     ...
     */
    public @OnClick(R.id.clear_button)
